...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "These three are for people without a starting point. Start Here asks four questions and names one piece to buy first. Learn explains the rules from zero. Wishlist Match reads a screenshot of your Amazon or Flipkart wishlist and works your taste out from that.",
    placement: "bottom",
  },
  {
    id: "result",
    ...
    body: "Every vibe resolves into three tiers. The hero piece does most of the styling work, the recommended edit agrees with it, and add-ons are optional. Under each piece, 'homegrown makers' opens the real labels that make it, with a link to their own store.",
    placement: "top",
  },
  {
    id: "occasion",
  ...
  },
  {
    ...
    body: "Every recommendation points here rather than at a marketplace. Studios in Jaipur, Mumbai and Bengaluru, filterable by what they make and what you want to spend. Links go to the maker's own store, so they keep the margin.",
    placement: "top",
  },
  {
    id: "learn",
  ...
  },
  {
    ...
    body: "Every piece has an 'I own this' toggle. Mark a few and My Drawer works out which vibes you can already pull off, and which single purchase unlocks the most new looks. It's stored in your browser only.",
    placement: "top",
  },
  {
    id: "finish",
    ...
    body: "You're on Start Here now — four questions and you'll have a brief with one piece to buy first. You can reopen this tour any time from the ? button in the header.",
  },
];
